...
웹앱으로 배포하기 위해 코드 형식을 수정하고 깃허브와 streamlit을 이용해 공공 배포가 가능한 형태로 만들었다.
...
과정: 음식 종류에 따라 변수 세팅을 다르게 했다. 각 음식의 특성과 수분활성도에 따른 변수 민감도를 다르게 모델링해 실제 상황에서 적용 가능한 맞춤형 시뮬레이터를 만들기 위해 노력했다. 
